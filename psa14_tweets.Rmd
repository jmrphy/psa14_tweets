...
To get some traction on questions such as these, below I analyze all the tweets containing the hashtag #PSA14 between Monday April 14 (roughly 9 a.m.) until Wednesday April 16th (roughly 8 p.m.) to answer some of these questions. As with all social media data, these analyses are almost certainly not representative of the whole population of attendees. 
